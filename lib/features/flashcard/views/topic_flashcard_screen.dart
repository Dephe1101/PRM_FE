...
class TopicFlashcardScreen extends ConsumerStatefulWidget {
  final String topicId;
  final String topicName;

  const TopicFlashcardScreen({
    super.key,
  ...
  @override
  ConsumerState<TopicFlashcardScreen> createState() =>
      _TopicFlashcardScreenState();
}
      ...
      body: state.when(
        data: (flashcards) {
          if (flashcards.isEmpty) {
            return const Center(child: Text('Topic này chưa có từ vựng nào.'));
          }
                        ...
                        return Center(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                'Bạn đã hoàn thành\ntất cả từ vựng trong Topic này!',
                              ...
                              ElevatedButton(
                                onPressed: () async {
                                  ...
                                  final success = await ref
                                      .read(
                                        batchFlashcardActionProvider.notifier,
                                      )
                                      .submitBatch();
                                  ...
                                  if (context.mounted) {
                                    ...
                                    if (success) {
                                      ScaffoldMessenger.of(
                                        ...
                                        const SnackBar(
                                          content: Text(
                                            'Lưu kết quả học tập thành công!',
                                          ),
        ...
        error: (e, st) => Center(
          child: ErrorRetryWidget(
            ...
            onRetry: () => ref.invalidate(
              topicFlashcardControllerProvider(widget.topicId),
            ),
          ),
        ),
      ),
